...
import {
  Cell,
  HeaderCell as FormatHeaderCell,
  RowHeaderCell,
  Table,
  Row,
} from '../../utils/format'
...
const renderTeamRow = (team, name, isDark, i = 0) => (
  <Row style={{ backgroundColor: getOddRowColor(i, isDark) }}>
    ...
    <Cell>
      {team.fastBreakPoints || 0} ({team.fastBreakPointsMade || 0}-
      {team.fastBreakPointsAttempted || 0})
    </Cell>
    <Cell>
      {team.pointsInPaint || 0} ({team.pointsInPaintMade || 0}-
      {team.pointsInPaintAttempted || 0})
    </Cell>
