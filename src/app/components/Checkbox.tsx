...
export const HideZeroRowCheckbox = () => (
  <BoxScoreConsumer>
    {({ state: { hideZeroRow }, actions: { updateHideZeroRow } }) => (
      <Checkbox
        checked={hideZeroRow === true}
        text="Hide Player Who Has Not Played"
        onChange={updateHideZeroRow}
      />
    )}
  </BoxScoreConsumer>
)
...
export const BroadcastCheckbox = () => (
  <SidebarConsumer>
    {({ state: { broadcast }, actions: { updateBroadcast } }) => (
      <Checkbox
        checked={broadcast === true}
        text="Show Broadcasters"
