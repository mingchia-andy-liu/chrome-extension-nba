    ...
    if (game.stt === 'TBD') {
        ...
        if ((game.h.ot1 && game.h.ot1 !== 0) || (game.v.ot1 && game.v.ot1 !== 0)) {
            matchinfoEl
                .find('.c-clock')
                .text('Final/OT')
                .addClass(UTILS.CLOCK)
                .removeClass(UTILS.TIME)
        } else {
            matchinfoEl
                .find('.c-clock')
                .text('Final')
        ...
        if (parseInt(game.v.s) > parseInt(game.h.s)) $(scores[0]).addClass(COLOR.GREEN)
        else if (parseInt(game.v.s) < parseInt(game.h.s)) $(scores[1]).addClass(COLOR.GREEN)
