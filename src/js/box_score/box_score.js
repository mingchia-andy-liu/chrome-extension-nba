$(function() {
    ...
    function showBox(g) {
        ...
        $('#away_team_stats tbody tr:nth-child(2)')
            .children()
            .each(function(index, el) {
                $(el).text(teamStatsRow[1][index])
            })

        $('.detail-box-score tbody tr:nth-child(2)')
            .children()
            .each(function(index, el) {
                if (index === 0) {
                    $(el).text(g.vls.ta)
        ...
        $('#home_team_stats tbody tr:nth-child(2)')
            .children()
            .each(function(index, el) {
                $(el).text(teamStatsRow[1][index])
            })
        $('.detail-box-score tbody tr:nth-child(3)')
            .children()
            .each(function(index, el) {
                if (index === 0) {
                    $(el).text(g.hls.ta)
    ...
    function removeBox() {
        ...
        $('.summary-box-score tbody tr:nth-child(1)')
            .children()
            .each(function(index, el) {
                if (index > 4 && index < 14) {
        ...
        $('.summary-box-score tbody tr:nth-child(2)')
            .children()
            .each(function(index, el) {
        ...
        $('.summary-box-score tbody tr:nth-child(3)')
            .children()
            .each(function(index, el) {
                $(el).removeClass(COLOR.RED)
                if (index > 4 && index < 14) {
        ...
        $('#away_box_score tbody tr:not(:first-child)').each(function(rowNum, row) {
            ...
            $(row)
                .children()
                .each(function(colNum, cell) {
                    $(cell)
                        .text(EMPTY_PLAYER_ROW[colNum])
                        .show()
                        .attr('colspan', 1)
                })
        })
